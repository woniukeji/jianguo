 package com.woniukeji.jianguo.camera;
...
public class CameraCropBorderView extends View {
	 ...
	 * 边框以外的颜色
	 */
	private int mFillColor = Color.parseColor("#55000000");
	/**
	 * 边框的宽度 单位dp
	 */
	...
	protected void onDraw(Canvas canvas) {
		if (isFirst) {
			...
			int left = 0;
			int top = (int) (screenH*0.067);
			int right = left + mWidth;
			int bottom = top + srceenW/3*2;
