package com.woniukeji.jianguo.widget.time;
 ...
 * @author chenjing
 */
public class PickerSize extends View {
    ...
    public PickerSize(Context context) {
        super(context);
        init();
    }

    public PickerSize(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
