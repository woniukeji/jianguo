...
public class MyPartJboActivity extends BaseActivity {
    ...
    private String[] mTitles = {"待录取", "已录取","已完成"};
...
//                }
    ...
    public void addActivity() {
        ActivityManager.getActivityManager().addActivity(MyPartJboActivity.this);
    }
