...
public class DropDownMenu extends LinearLayout{
    ...
    // Menu 展开的 list item
    private List<List<BaseEntity>> mMenuItems=new ArrayList<>();
    //菜单 上的文字
...
//    }
    // 设置 Menu的item
    public void setmMenuItems(List<List<BaseEntity>> menuItems) {
        mMenuItems = menuItems;
        mDrawable=true;
        invalidate();
    }
        ...
        if (mDrawable) {
            ...
            mMenuList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    int sortId=mMenuItems.get(mColumnSelected).get(position).getId();
                    ...
                    if (mMenuSelectedListener == null && isDebug)
                        ...
                        mMenuSelectedListener.onSelected(view, mRowSelected, mColumnSelected,sortId);
                }
            });
