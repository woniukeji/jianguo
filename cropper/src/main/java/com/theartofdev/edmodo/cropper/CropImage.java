...
public final class CropImage {
     ...
     */
    public static final int PICK_IMAGE_CHOOSER_REQUEST_CODE1 = 207;
    public static final int PICK_IMAGE_CHOOSER_REQUEST_CODE2 = 208;
    /**
     ...
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE1 = 205;
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE2 = 206;
    /**
    ...
    public static void startPickImageActivity(@NonNull Activity activity) {
        activity.startActivityForResult(getPickImageChooserIntent(activity), PICK_IMAGE_CHOOSER_REQUEST_CODE1);
    }
    public static void startPickImageActivity(@NonNull Activity activity,int repuestCode) {
        activity.startActivityForResult(getPickImageChooserIntent(activity), repuestCode);
    }
    /**
    ...
    public static final class ActivityBuilder {
        ...
        public void start(@NonNull Activity activity, @Nullable Class<?> cls) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity, cls), CROP_IMAGE_ACTIVITY_REQUEST_CODE1);
        }
        ...
        public void start(@NonNull Context context, @NonNull Fragment fragment, @Nullable Class<?> cls) {
            fragment.startActivityForResult(getIntent(context, cls), CROP_IMAGE_ACTIVITY_REQUEST_CODE1);
        }
